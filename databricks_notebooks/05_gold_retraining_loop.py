...
MLFLOW_EXPERIMENT_NAME = "/Shared/DriftingOracle_Baseline"
...
spark_comparison = spark.createDataFrame(df_gold_comparison)
spark_comparison.write.format("delta").mode("append").saveAsTable(GOLD_MODEL_COMPARISON)
