...
LR_PARAMS = {"max_iter": 500, "random_state": 42}
RF_PARAMS = {"n_estimators": 50, "max_depth": 5, "random_state": 42, "n_jobs": -1}
...
df_home_spark = spark.read.table(SILVER_HOME_CREDIT)
...
with mlflow.start_run(run_name=f"Champion_{champion['model'].replace(' ', '_')}"):
    ...
    # Set alias on Databricks Unity Catalog
